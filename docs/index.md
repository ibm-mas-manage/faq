...
**4. Can you please elaborate on ibm icr.io?**
...
**5. For organizations that are on windows, are there options or only options to provision new RHEL envs /  move to cloud?**
...
**6. What is the one big limitation of moving to OpenShift?**

Potentially more hardware is needed for smaller installations
Short term learning curve (like any new technology)

**7. Are there specific requirements for a multi-tenancy environment?**

MT is not yet supported in OpenShift.

**8. Does OpenShift allow dynamic scaling?**

Yes, but MAS is not fully there yet.

**9. Is the hypervisor something IBM provides or is that open source?**

There are different hypervisor products. Windows server datacenter solution provides windows hypervisor license. 

**10. Where does that plan into the diagram if you were to use windows?**

Windows is not supported at this time unless unsing sSphere
  
**11. What environment changes require application outages for users?**
...
**12. What databases are supported?.**

All three databases (Db2, Db2 Warehouse, Oracle and SQL server) are supported.

**13. What Industry Solution/Add-ons are supported?**
...
**15. Are Oracle and SAP integrations supported?**

Yes, Oracle and SAP integrations are supported.

**16. What are the supported authentication methods in MAS?**
...
**17. What authentication is needed for inbound HTTP/SOAP/REST-based integration to Manage?**
...
**18. What is the replacement of SI bus?**
...
**20. Is BIRT reporting supported?**

Yes, BIRT is supported. Your reports will be moved automatically with the database upgrade.

**21. How to restart Manage server (other than deleting pods or restarting pods)?**
...
**22. How to deploy a custom Java class?**
...
**23. How do we access the System.Out logs for Maximo?**
...
**27. How is SMTP server configured?**
...
**28. How certificates can be applied?**
...
**2. What is the rollback process when a patch fails at the app layer or the db layer**
