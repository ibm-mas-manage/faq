...
- **What environment changes require application outages for users?**
	...
	change that requires the pods to go down. This is similar to today with when you need to restart the JVM.  For example, applying a new custom archive with your customization.
